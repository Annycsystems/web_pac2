...
from .models import tipo_solicitud, pers_gen, users_sys, primer_registro, usr_sol_dom, usr_sol_rfc, track_sol
...
def bienvenido(request):
    ...
    return render(request, 'cambiodatos/inicio_Sesion.html', {'forma_nuevo_usuario': forma_nuevo_usuario})
    # return render(request, 'cambiodatos/inicio_Sesion.html')


def rec_pass(request):
    return render(request, 'cambiodatos/recuperar_Contrasenia.html')

def main(request):
    return render(request, 'cambiodatos/main.html')
# def main(request):
#     return render(request, 'cambiodatos/menuPrincipal.html')
# def main(request):
#     return render(request, 'cambiodatos/tkn_template.html')

def bienvenidos(request):
    return render(request, 'cambiodatos/bienvenido.html')
...
def new_pers(request):
    ...
    if request.method == "POST":
        ...
        forma_nuevo_usuario = NewpersonForm()
    return render(request, 'cambiodatos/Sign_in.html', {'forma_nuevo_usuario': forma_nuevo_usuario})
...
def search_pers(request):
    ...
    if exis:
        ...
        if vali == '1':
            ...
            return render(request, 'cambiodatos/menuPrincipal.html', {'persons': persons, 'data': data, 'data2': data2})
...
def uploadFile(request):
    if request.method == "POST":
        ...
        if str(str(resp["estatus"])) == "OK":
            ...
            temp = "cambiodatos/correo_datos_gen.html"
            adi="Datos generales"
            folio = ''
        ...
        if str(str(resp["estatus"])) == "ERROR":
            ...
            print("ok");
            return render(request, "cambiodatos/First_access.html")
    return render(request, "cambiodatos/First_access.html")
...
def uploadTickdirect(request):
    if request.method == "POST":
        ...
        # document.save()
            return render(request, "cambiodatos/tkn_template.html", {"docs": document})
    return render(request, "cambiodatos/menuPrincipal.html")
